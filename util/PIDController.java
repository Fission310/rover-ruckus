...
public class PIDController {
    private double m_P, m_I, m_D, m_input;  // factor for each control
    private double m_maximumOutput = 1.0;   // |maximum output|
    private double m_minimumOutput = -1.0;  // |minimum output|
    private double m_maximumInput = 0.0, m_minimumInput = 0.0;    // maximum and minimum input - limit setpoint to this
    private boolean m_continuous = false, m_enabled = false;   // do the endpoints wrap around? eg. Absolute encoder
