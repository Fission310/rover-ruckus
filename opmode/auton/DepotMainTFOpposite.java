...
@Autonomous(name="Main TF Depot Opposite: D;S;M;P", group="Slide Depot")
public class DepotMainTFOpposite extends LinearOpMode {
...
//                    robot.drivetrain.imuStartingRot();
                 ...
                 */
                case SAMPLE:
                    robot.tfDepotSamplePIDOpposite(goldLocation);
