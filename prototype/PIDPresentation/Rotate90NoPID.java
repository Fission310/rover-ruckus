...
@Autonomous(name="Rotate 90 NO PID", group="PID")
public class Rotate90NoPID extends LinearOpMode {
    ...
    public void runOpMode() {
         ...
         */
        robot.drivetrain.turnNoPID(.3,-90.0,4);

        sleep(2000);

        robot.drivetrain.driveToPosNoPID(.3,5.0,5.0,4);
