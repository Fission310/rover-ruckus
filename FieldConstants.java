...
public class FieldConstants {
    ...
    public static final double FLOOR_TILE = 24; // Length in inches *Almost 24 inches
    public static final double TILE_HYPOTENUSE = 24 * Math.sqrt(2); // Length in inches
    public static final double HANG_HEIGHT = 22; // Height in inches
